    ...
    render() {
        return (
            <aside className="col-3 p-2 bg-light">
                ...
                <Scrollbars
                    autoHide
                    style={{ height: this.props.windowHeight - 300 }} >
                    <center>
                                    ...
                                    <div className="panel-heading" role="tab" id="headingOne4">
                                        <h4 className="panel-title text-left">
                                            <a role="button" data-toggle="collapse" data-parent="#accordion4" href="#collapseOne4" aria-expanded="true" aria-controls="collapseOne4">
                                                <FontAwesomeIcon icon={faSlidersH} className="InfoPanel--accordion-icon" />
                                                Options
                                            </a>
                                        </h4>
                                    </div>
                                    ...
                                    <div className="panel-heading" role="tab" id="headingTwo4">
                                        <h4 className="panel-title text-left">
                                            <a className="collapsed" role="button" data-toggle="collapse" data-parent="#accordion4" href="#collapseTwo4" aria-expanded="false" aria-controls="collapseTwo4">
                                                <FontAwesomeIcon icon={faFileAlt} className="InfoPanel--accordion-icon" />
                                                Shared Files
                                            </a>
                                        </h4>
                                    </div>
                                        ...
                                        <table className="table table-bordered table-hover table-foldersystem">
                                                <tbody>
                                                    <tr className="InfoPanel--file-row">
                                                        <td>
                                                            <a href="#">
                                                                <FontAwesomeIcon icon={faFolderOpen} className="InfoPanel--fileicon" />
                                                                Images
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <tr className="InfoPanel--file-row">
                                                        <td><a href="#">
                                                            <FontAwesomeIcon icon={faCss3} className="InfoPanel--fileicon" />
                                                            CSS
                                                        </a>
                                                        </td>
                                                    </tr>
                                                    <tr className="InfoPanel--file-row">
                                                        <td>
                                                            <a href="#">
                                                                <FontAwesomeIcon icon={faJsSquare} className="InfoPanel--fileicon" />
                                                                JS
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <tr className="InfoPanel--file-row">
                                                        <td>
                                                            <a href="#">
                                                                <FontAwesomeIcon icon={faImage} className="InfoPanel--fileicon" />
                                                                logo.jpg
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <tr className="InfoPanel--file-row">
                                                        <td>
                                                            <a href="#">
                                                                <FontAwesomeIcon icon={faFileVideo} className="InfoPanel--fileicon" />
                                                                teaser.mp4
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <tr className="InfoPanel--file-row">
                                                        <td>
                                                            <a href="#">
                                                                <FontAwesomeIcon icon={faFileCode} className="InfoPanel--fileicon" />
                                                                index.php
                                                            </a>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div className="panel-heading" role="tab" id="headingThree4">
                                        <h4 className="panel-title text-left">
                                            <a className="collapsed" role="button" data-toggle="collapse" data-parent="#accordion4" href="#collapseThree4" aria-expanded="false" aria-controls="collapseThree4">
                                                <FontAwesomeIcon icon={faImages} className="InfoPanel--accordion-icon" />
                                                Shared Photos
                                            </a>
                                        </h4>
                                    </div>
