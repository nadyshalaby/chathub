  ...
  render() {
    return (
      <div>
        ...
        <Scrollbars autoHide style={{ height: this.props.windowHeight - 157 }}>
          <div className="list-group UsersList--items-wrapper">
            <UsersListItem
              avatar={Avatar}
              username="Nady Shalaby"
              timeAgo="3 min ago"
              msg="Donec id elit non mi porta gravida at eget metus."
            />
            <UsersListItem
              avatar={Avatar}
              username="Nady Shalaby"
